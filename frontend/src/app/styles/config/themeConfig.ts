...
const config = defineConfig({
  ...
  theme: {
    ...
    tokens: {
      ...defaultBaseConfig.theme?.tokens,
      colors: {
        ...defaultBaseConfig.theme?.tokens?.colors,
        teal: {
          50: { value: '#e0f7f7' },
          100: { value: '#b3e7e7' },
          200: { value: '#80d4d4' },
    ...
    semanticTokens: {
      ...defaultBaseConfig.theme?.semanticTokens,
      colors: {
        ...defaultBaseConfig.theme?.semanticTokens?.colors,
